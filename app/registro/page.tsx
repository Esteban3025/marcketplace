      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-slate-900">PuestoFlex</span>
          </Link>
        </div>
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Únete a la comunidad de PuestoFlex</CardDescription>
          </CardHeader>
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" type="text" placeholder="Tu nombre completo" className="pl-10" required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="location" type="text" placeholder="Ciudad, Provincia" className="pl-10" required />
                </div>
              </div>
